    ...
    <div className="container p-5 w-50 bg-light rounded">
      <div className="mb-3 row">
        ...
        <div className="col-sm-10">
          <input type="number"  value = {numA} onChange={(e) => setNumA(e.target.value)}  className="form-control" id="numA"/>
        </div>
      </div>
      <div className="mb-3 row">
        <label htmlFor="inputPassword" className="col-sm-2 col-form-label">Numero B</label>
        <div className="col-sm-10">
          <input type="number" value = {numB} onChange={(e) =>  setNumB(e.target.value)} className="form-control" id="numB"/>
        </div>
      </div>
      <div className="mb-3 row">
        <label className="col-sm-2 col-form-label">Operacion</label>
        <div className="col-sm-10">
          <select class="form-select form-select-sm" aria-label="Small select example" value = {operator} onChange={ (e) => (setOperator(e.target.value))} id="opt" >
      ...
      <div className="mb-3 row">
        <div className="col-sm-2">
          <button type="button" class="btn btn-primary" onClick={ () => operation()} id="btn">Resultado</button>
        </div>
      </div>
      <div className="mb-3 row">
        <label htmlFor="inputPassword" className="col-sm-2 col-form-label">Resultado</label>
        <div className="col-sm-10">
          <input type="number" readOnly value = {result} className="form-control" id="result"/>
        </div>
      </div>
    </div>
  );
